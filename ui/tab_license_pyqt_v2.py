...
class LicenseDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        pc_id_label.setStyleSheet("color: #94A3B8; font-size: 12px;")
...
class LicensePage(QScrollArea):
    ...
    def setup_ui(self):
        ...
        subtitle = QLabel("Manage your application license")
        ...
        pc_title.setStyleSheet("color: #FFFFFF; font-size: 16px; font-weight: 700;")
        ...
        pc_desc.setStyleSheet("color: #94A3B8; font-size: 12px;")
        ...
        contact_title.setStyleSheet("color: #FFFFFF; font-size: 16px; font-weight: 700;")
        contact_layout.addWidget(contact_title)

        contact_text = QLabel("Contact:\nEng. Justo Torres\nghost.jgtv@gmail.com")
        contact_text.setStyleSheet("color: #94A3B8; font-size: 14px;")
